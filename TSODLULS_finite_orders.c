...
}//end TSODLULS_get_uint_from_float()
...
float TSODLULS_get_float_from_uint(uint32_t i32){
  ...
  return temp.f;
}//end TSODLULS_get_float_from_uint()
...
}//end TSODLULS_get_uint_from_double()
...
double TSODLULS_get_double_from_uint(uint64_t i64){
  ...
  return temp.d;
}//end TSODLULS_get_double_from_uint()
...
}//end TSODLULS_get_uint8_from_int8()
...
}//end TSODLULS_get_int8_from_uint8()
...
}//end TSODLULS_get_uint16_from_int16()
...
}//end TSODLULS_get_int16_from_uint16()
...
}//end TSODLULS_get_uint32_from_int32()
...
}//end TSODLULS_get_int32_from_uint32()
...
}//end TSODLULS_get_uint64_from_int64()
...
}//end TSODLULS_get_int64_from_uint64()
...
int TSODLULS_add_bytes_to_key_from_uint8(
  ...
  if(i_number_of_lex_padding_bytes == -1//4 bits are sufficient
    ...
    p_sort_element->s_key[p_sort_element->i_key_size++] = (unsigned char)i8;
    p_sort_element->s_key[p_sort_element->i_key_size++] = 240;
  }
  else{
  ...
  return 0;
}//end TSODLULS_add_bytes_to_key_from_uint8
...
int TSODLULS_add_bytes_to_key_from_uint16(
  ...
  if(i_number_of_lex_padding_bytes == -1//4 bits are sufficient
    ...
    p_sort_element->s_key[p_sort_element->i_key_size++] = 240;
    p_sort_element->s_key[p_sort_element->i_key_size++] = (unsigned char)(i16 >> 8);
    p_sort_element->s_key[p_sort_element->i_key_size++] = 240;
    p_sort_element->s_key[p_sort_element->i_key_size++] = 240;
    p_sort_element->s_key[p_sort_element->i_key_size++] = (unsigned char)(i16 % 256);
    p_sort_element->s_key[p_sort_element->i_key_size++] = 240;
  }
  else{
    for(int8_t i = 0; i < i_number_of_lex_padding_bytes; ++i){
  ...
  return 0;
}//end TSODLULS_add_bytes_to_key_from_uint16
...
int TSODLULS_add_bytes_to_key_from_uint32(
  ...
  if(i_number_of_lex_padding_bytes == -1//4 bits are sufficient
    ...
    p_sort_element->s_key[p_sort_element->i_key_size++] = 240;
    p_sort_element->s_key[p_sort_element->i_key_size++] = (unsigned char)(i32 >> 24);
    p_sort_element->s_key[p_sort_element->i_key_size++] = 240;
    p_sort_element->s_key[p_sort_element->i_key_size++] = 240;
    p_sort_element->s_key[p_sort_element->i_key_size++] = (unsigned char)((i32 >> 16) % 256);
    p_sort_element->s_key[p_sort_element->i_key_size++] = 240;
    p_sort_element->s_key[p_sort_element->i_key_size++] = 240;
    p_sort_element->s_key[p_sort_element->i_key_size++] = (unsigned char)((i32 >> 8) % 256);
    p_sort_element->s_key[p_sort_element->i_key_size++] = 240;
    p_sort_element->s_key[p_sort_element->i_key_size++] = 240;
    p_sort_element->s_key[p_sort_element->i_key_size++] = (unsigned char)(i32 % 256);
    p_sort_element->s_key[p_sort_element->i_key_size++] = 240;
  }
  else{
    for(int8_t i = 0; i < i_number_of_lex_padding_bytes; ++i){
  ...
  return 0;
}//end TSODLULS_add_bytes_to_key_from_uint32
...
int TSODLULS_add_bytes_to_key_from_uint64(
  ...
  if(i_number_of_lex_padding_bytes == -1//4 bits are sufficient
    ...
    p_sort_element->s_key[p_sort_element->i_key_size++] = 240;
    p_sort_element->s_key[p_sort_element->i_key_size++] = (unsigned char)(i64 >> 56);
    p_sort_element->s_key[p_sort_element->i_key_size++] = 240;
    p_sort_element->s_key[p_sort_element->i_key_size++] = 240;
    p_sort_element->s_key[p_sort_element->i_key_size++] = (unsigned char)((i64 >> 48) % 256);
    p_sort_element->s_key[p_sort_element->i_key_size++] = 240;
    p_sort_element->s_key[p_sort_element->i_key_size++] = 240;
    p_sort_element->s_key[p_sort_element->i_key_size++] = (unsigned char)((i64 >> 40) % 256);
    p_sort_element->s_key[p_sort_element->i_key_size++] = 240;
    p_sort_element->s_key[p_sort_element->i_key_size++] = 240;
    p_sort_element->s_key[p_sort_element->i_key_size++] = (unsigned char)((i64 >> 32) % 256);
    p_sort_element->s_key[p_sort_element->i_key_size++] = 240;
    p_sort_element->s_key[p_sort_element->i_key_size++] = 240;
    p_sort_element->s_key[p_sort_element->i_key_size++] = (unsigned char)((i64 >> 24) % 256);
    p_sort_element->s_key[p_sort_element->i_key_size++] = 240;
    p_sort_element->s_key[p_sort_element->i_key_size++] = 240;
    p_sort_element->s_key[p_sort_element->i_key_size++] = (unsigned char)((i64 >> 16) % 256);
    p_sort_element->s_key[p_sort_element->i_key_size++] = 240;
    p_sort_element->s_key[p_sort_element->i_key_size++] = 240;
    p_sort_element->s_key[p_sort_element->i_key_size++] = (unsigned char)((i64 >> 8) % 256);
    p_sort_element->s_key[p_sort_element->i_key_size++] = 240;
    p_sort_element->s_key[p_sort_element->i_key_size++] = 240;
    p_sort_element->s_key[p_sort_element->i_key_size++] = (unsigned char)(i64 % 256);
    p_sort_element->s_key[p_sort_element->i_key_size++] = 240;
  }
  else{
    for(int8_t i = 0; i < i_number_of_lex_padding_bytes; ++i){
  ...
  return 0;
}//end TSODLULS_add_bytes_to_key_from_uint64

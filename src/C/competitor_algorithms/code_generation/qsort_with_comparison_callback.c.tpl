 ...
 */
int TSODLULS_qsort__comparison_callback_@iNumberOfElementsForInsertionSort@(
  void* arr_elements,
...
}//end function TSODLULS_qsort__comparison_callback_@iNumberOfElementsForInsertionSort@

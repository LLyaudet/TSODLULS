...
int TSODLULS_qsort_inlined__short_@iNumberOfElementsForInsertionSort@(
  ...
  if(i_number_of_elements > @iNumberOfElementsForInsertionSort@){
    ...
    while(STACK_NOT_EMPTY){
      ...
      if((size_t)(right_ptr - lo) <= @iNumberOfElementsForInsertionSort@){
        if ((size_t) (hi - left_ptr) <= @iNumberOfElementsForInsertionSort@){
      ...
      else if ((size_t) (hi - left_ptr) <= @iNumberOfElementsForInsertionSort@){
  ...
  }//end if(i_number_of_elements > @iNumberOfElementsForInsertionSort@)
...
#define min(x, y) ((x) < (y) ? (x) : (y))

  {
    ...
    t_TSODLULS_sort_element__short* thresh = min(end_ptr, base_ptr + @iNumberOfElementsForInsertionSort@);
